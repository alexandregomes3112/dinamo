...
COMMAND_CODE="M2"                       # M2 - Decrypt Data Block Request+
MODE_FLAG="01"                          # Mode Flag - '01': CBC (requires an IV)
...
KEY_SN="1FFF0000000026E00263"           # The KSN supplied by the PIN pad. For further information on DUKPT,
IV="0000000000000000"                   # The input IV, to be used in conjunction with the decryption Key.
