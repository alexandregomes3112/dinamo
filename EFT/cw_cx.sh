...
HEADER="\x00\x3F"                           # 63 Bytes
MSG_HEADER="0000"                           # Header "0000" - ASCII
COMMAND_CODE="CW"                           # CW - Generate a Card Verification Code/Value Request
...
"${CVK_AB}${PRIMARY_ACCOUNT_NUMBER}${DELIMITER}${EXP_DATE}${SERVICE_CODE}"
